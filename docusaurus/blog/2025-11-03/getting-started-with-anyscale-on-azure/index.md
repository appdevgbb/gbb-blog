...
![Create API Key 1](/img/2025-11-03-getting-started-with-anyscale-on-azure/create_api_key_1.jpg)

In the next window (API Keys) click "+ Create", set the expiration date and then select "Create a secret key".

![Create API Key 2](/img/2025-11-03-getting-started-with-anyscale-on-azure/create_api_key_2.jpg)
...
![Create Workspace 1](/img/2025-11-03-getting-started-with-anyscale-on-azure/create_workspace_1.jpg)

![Create Workspace 2](/img/2025-11-03-getting-started-with-anyscale-on-azure/create_workspace_2.jpg)

![Create Workspace 3](/img/2025-11-03-getting-started-with-anyscale-on-azure/create_workspace_3.jpg)

If you check the anyscale-operator namespace in your cluster, you should see the workspace pod starting.

![Create Workspace 4](/img/2025-11-03-getting-started-with-anyscale-on-azure/create_workspace_4.jpg)

![Create Workspace 5](/img/2025-11-03-getting-started-with-anyscale-on-azure/create_workspace_5.jpg)

### Run a workload

![Hello World](/img/2025-11-03-getting-started-with-anyscale-on-azure/hello_world.jpg)
